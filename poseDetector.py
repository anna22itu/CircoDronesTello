...
class PoseDetector:
    ...
    def detect(self, image, level):
        self.poseLandmarks, img = self.__prepare(image)
        res = ''
        if len(self.poseLandmarks) >= 13:
            if level == 'difficult':
                '''
                if self.__p0(poseLandmarks):
                    ...
                    res = 5
                '''
                self.poseLandmarks = self.poseLandmarks[11:24]
                image = cv2.flip(image, 1)
                res, img = self.detector.detect(image, 60)
                print('detecto ', res)
                img = cv2.flip(img, 1)
                ...
                if ((self.poseLandmarks[12][1] < self.poseLandmarks[14][1])
                        and (self.poseLandmarks[14][1] < self.poseLandmarks[16][1])
                        and (self.poseLandmarks[11][1] < self.poseLandmarks[13][1])
                        and (self.poseLandmarks[13][1] < self.poseLandmarks[15][1])
                        and (self.poseLandmarks[18][0] < self.poseLandmarks[17][0])
                        and (self.poseLandmarks[17][0] > self.poseLandmarks[13][0])
                        and (self.poseLandmarks[18][0] < self.poseLandmarks[14][0])):
                    res = 6
                elif ((self.poseLandmarks[12][1] < self.poseLandmarks[14][1])
                      and (self.poseLandmarks[14][1] < self.poseLandmarks[16][1])
                      and (self.poseLandmarks[11][1] < self.poseLandmarks[13][1])
                      and (self.poseLandmarks[13][1] < self.poseLandmarks[15][1])
                      and (self.poseLandmarks[18][0] > self.poseLandmarks[17][0])):
                    res = 2
                elif ((self.poseLandmarks[14][1] > self.poseLandmarks[12][1])
                      and (self.poseLandmarks[14][1] > self.poseLandmarks[16][1])
                      and (self.poseLandmarks[13][1] > self.poseLandmarks[11][1])
                      and (self.poseLandmarks[13][1] > self.poseLandmarks[15][1])
                      and (self.poseLandmarks[18][0] > self.poseLandmarks[17][0])):
                    res = 7

                elif (self.poseLandmarks[12][1] < self.poseLandmarks[14][1]) and (self.poseLandmarks[11][1] > self.poseLandmarks[13][1]):
                    res = 3
                elif (self.poseLandmarks[12][1] > self.poseLandmarks[14][1]) and (self.poseLandmarks[11][1] < self.poseLandmarks[13][1]):
                    res = 4
                elif (self.poseLandmarks[12][1] > self.poseLandmarks[14][1]) and (self.poseLandmarks[11][1] > self.poseLandmarks[13][1]):
                    if self.poseLandmarks[18][0] > self.poseLandmarks[17][0]:
                        res = 1
                    if self.poseLandmarks[18][0] < self.poseLandmarks[17][0]:
                        res = 5
