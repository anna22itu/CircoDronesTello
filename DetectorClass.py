...
class MovementGenerator:
    ...
    def __init__(self, anchura, altura, profundidad):
        ...
        self.left_right = 0
        self.forward_back = 0
        self.fliped = True  # Solo le dejaremos hacer flip una vez
...
'''
class DetectorClass:
    def __init__(self, drone, escenario, poseList, photos, integer_value):
        ...
        self.int_camera = integer_value
        print(self.int_camera)
    ...
    def easy(self):
        ...
        self.image = self.image.resize((160, 450))
        self.bg = ImageTk.PhotoImage(self.image)
        ...
        messagebox.showwarning("Info", "Estás en el modo fácil con el que detectarás poses ya hechas!",
                               parent=self.master)
    ...
    def difficult(self):
        if self.poseList == None:
            ...
            self.imageAdelante = self.imageAdelante.resize((100, 40))
            ...
            self.imageAtras = self.imageAtras.resize((100, 40))
            ...
            self.imageIzquierda = self.imageIzquierda.resize((100, 40))
            ...
            self.imageDerecha = self.imageDerecha.resize((100, 40))
            ...
            self.imageArriba = self.imageArriba.resize((100, 40))
            ...
            self.imageAbajo = self.imageAbajo.resize((100, 40))
            ...
            messagebox.showwarning("Info", "Estás en el modo difícil con el que detectarás tus propias poses!", parent=self.master)
    ...
    def buildFrame(self, fatherFrame, mode):
        ...
        self.videostreamer = VideoStreamer(self.int_camera)  # Transmisión

        messagebox.showwarning("Info", "Estás en el modo fácil con el que detectarás poses ya hechas! Si quieres hacerlo más difícil, selecciona el botón 'Tus poses'!",
                               parent=self.master)
    ...
    def practising(self):
        ...
        while self.state == 'practising':
            ...
            cv2.waitKey(1)
        cv2.destroyWindow('videoPractising')
        cv2.waitKey(1)
    ...
    def flying(self):
        ...
        self.direction = ''
        # numero de órdenes que debe superar el jugador para triunfar
        ...
        while next < numberOfOperations:
                ...
                while not detected and self.aviso != 2:
                    ...
                    if code == n+1:
                        ...
                        # ha cambiado de pose / no detecta bien la posición
                        cont = 0
