...
class CircoImagenes:
    ...
    def Open(self, master):
        ...
        connectButton.place(x=330, y=300, anchor="nw")
        connectButton['font'] = myFont

        # Nivel bateria label
        self.batteryLbl = Label(self.newWindow, text="Nivel de bateria: ????", height=1, bg='#696969',
        ...
        empezarButton.place(x=380, y=520, anchor="nw")
    ...
    def foto(self):
        self.escenarioImagenes.Open(self.circusWindow)

    def panoramica(self):
        self.escenarioPanoramica.Open(self.circusWindow)

    def video(self):
        self.escenarioVideo.Open(self.circusWindow)
